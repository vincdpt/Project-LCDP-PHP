...
class UserDAO extends DAO implements UserProviderInterface
{
     ...
     *
     * @return \PPE_PHP\Domain\User|throws an exception if no matching user is found
     */
     ...
     *
     * @param \PPE_PHP\Domain\User $user The user to save
     */
    ...
    {
        return 'PPE_PHP\Domain\User' === $class;
    }
