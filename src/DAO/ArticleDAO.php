...
class ArticleDAO extends DAO
{
     ...
     *
     * @return \PPE_PHP\Domain\Article|throws an exception if no matching article is found
     */
     ...
     *
     * @param \PPE_PHP\Domain\Article $article The article to save
     */
